    ...
    computed: {
        filtered: function() {
            return this.items.filter(item => {
                ...
                const lowerCase_input = this.message.toLowerCase();
